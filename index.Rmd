...
description: |
  Although you might be intimidated by starting with R, this website is here to help you get established in R so that you will be equipped with the basics of this program! This website was created by the CDS to support students.
...
![An overview of the R Training Program timeline - see specific topics below](resources/CDS_R_Training_v2.png)

Please note that this site is *work-in-progress*.

## [S1 (Fall): Basic R skills](session0.html)
