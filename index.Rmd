...
For the first semester (S1 Fall), there are 11 topics for four modules in this R training. For each topic, we have compiled different online materials for you to go through, as well as assignments for you to test your skills. This training is a self-guided learning, which allows you to engage with the material at your own pace and at times that suit you the most. These topics will help you acquire basic skills in R, which will be most useful in the upcoming CDS Hackathons. 
...
| 2 | The Basics | [Visualization Basics](session3.html) | [pdf](index.html) |
| 3 | The Basics | [Programming Basics](session4.html) | [pdf](index.html) |
| 4 | Work with Data | [Working with Tibbles/Isolating Data with dplyr](session5.html) |  |
| 5 | Work with Data | [Derive Information with dplyr](session6.html) |  |
| 6 | Visualize Data | [Exploratory Data Analysis](session1.html) | [pdf](index.html) |
